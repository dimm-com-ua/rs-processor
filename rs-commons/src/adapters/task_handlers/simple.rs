...
impl TaskHandlerTrait for SimpleHandler {
    async fn process(&self, _task_worker: TaskWorker, dbs: &DbServices, _app: &App, args: Option<Vec<TaskVariable>>, tr: &Transaction<'_>) -> Result<TaskWorkerResult, ErrorDefinition> {
